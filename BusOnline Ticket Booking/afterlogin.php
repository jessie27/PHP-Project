...
<html>
   <head>
	...
	<link rel="stylesheet" href="styles/styles_afterlogine.css" media="all"/>   
   ...
   <table align="center"  width="650" height="550" border="2" bgcolor="wheat">
      ...
      <tr align="center">
	  <td colspan="7"><b>Book Your Ticket Here<b></td>
	  </tr>
	  
      <tr>
	    <td align="right"><b>Bus name:</b></td>
		<td>
		<select name="bname" required="required">
...
<?php
  ...
  if(isset($_POST['insert_post'])){
	...
	(userid,username,bname,type,fromd,tod,seat,year,month,day,time) values (
    '$userid','$username','$bname','$type','$fromd','$tod','$seat','$year','$month','$day','$time')";
	   
	   $insert_da = mysqli_query($con, $insert_data);
	   if($insert_da){
		   echo "<script>alert('Your Information Has Been Recorded!')</script>";
		   echo "<script>window.open('user_fetch.php','_self')</script>";
